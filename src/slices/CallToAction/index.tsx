...
const CallToAction = ({ slice }: CallToActionProps): JSX.Element => {
  return (
    ...
    >
      <div className="glow absolute -z-10 aspect-square w-full max-w-sm rounded-full bg-blue-200/50 blur-[140px] filter" />

      <div className="glass-container rounded-lg bg-gradient-to-b from-slate-800 to-slate-900 p-4 md:rounded-xl">
        <PlainLogo />
      </div>

      <div className="mt-8 max-w-xl text-balance text-5xl font-bold">
